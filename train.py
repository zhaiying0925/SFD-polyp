...
from diffusion_model.trainer_amp import GaussianDiffusion, Trainer
...
parser.add_argument('-i', '--inputfolder', type=str, default="/root/autodl-tmp/TrainDataset/masks")
parser.add_argument('-l', '--targetfolder', type=str, default="/root/autodl-tmp/TrainDataset/images")
...
trainer = Trainer(
    ...
    results_folder = './base_SIM_style1.0_new',
)
